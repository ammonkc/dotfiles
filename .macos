...
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "ammonkc - MackBook Pro"
...
# sudo systemsetup -settimezone "Pacific/Honolulu" > /dev/null
